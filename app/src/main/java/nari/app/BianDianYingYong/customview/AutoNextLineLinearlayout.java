...
/**
 * 自动换行的LineLinearlayout 通过重写onmeasure与layout方法实现对规则子View的换行排布
...
public class AutoNextLineLinearlayout extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //Toast.makeText(BaseApplication.context(), pos.left+" "+pos.top+" "+pos.right+" "+pos.bottom, Toast.LENGTH_SHORT).show();
            if (pos != null) {
