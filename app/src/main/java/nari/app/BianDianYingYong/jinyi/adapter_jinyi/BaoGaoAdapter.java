...
/**
 * Created by ShawDLee on 2018/1/16.
 */

public class BaoGaoAdapter extends BaseAdapter {
    private Context mContext;
    private List<PingjiabaogaoBean> baoGaoList;
    public static ProgressDialog progressDialog;

    public BaoGaoAdapter(Context context, List<PingjiabaogaoBean> baoGaoList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view.setTag(holder);
        holder.tv_pjbg_rwmc.setText(baoGaoList.get(i).getPJRWMC());
    ...
    public static class ViewHolder {
        ...
        @InjectView(R.id.tv_pjbg_rwmc)
        TextView tv_pjbg_rwmc;
