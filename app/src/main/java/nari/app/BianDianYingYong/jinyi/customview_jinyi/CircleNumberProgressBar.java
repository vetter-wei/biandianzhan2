...
public class CircleNumberProgressBar extends ProgressBar {
    ...
    public CircleNumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        dp_offset = typedArray.getDimensionPixelSize(R.styleable.CircleNumberProgressBar_cnpb_dpoffset,sp2px(14));
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (getProgress()==0){
             ...
             text = mUnitVisibility == VISIBLE ? getProgress() + mUnit : getProgress() + "";
        }
        text = "";
        ...
        if (mTextVisibility == VISIBLE) {
            ...
            canvas.drawText(text, mRadius - mBound.width() / 2, baseline-dp_offset, mPaint);
        }
    ...
    public void setDp_offset(int dp_offset) {
        this.dp_offset = dp_offset;
    }
